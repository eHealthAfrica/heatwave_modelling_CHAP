...
- [ ] 04-01-PLAN.md — Earth Engine async batch-export harness (`heatwave/batch.py`) plus a real live `Export.table.toAsset` round-trip de-risk, and the `tests/test_export.py` scaffold (EXPORT-01, EXPORT-04)
...
| 4. Batch Export & Covariate Table | 0/4 | Planned     | - |
